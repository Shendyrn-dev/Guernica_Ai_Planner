...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="id" suppressHydrationWarning className={`${geistSans.variable} ${geistMono.variable} h-full bg-background antialiased scroll-smooth`}>
      <body suppressHydrationWarning className="relative min-h-full flex flex-col bg-transparent text-foreground">
